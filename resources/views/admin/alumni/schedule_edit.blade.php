      ...
      <table class="table table-bordered">
        ...
        <tbody id="item">
         @foreach ($model->schedule as $element)
            <tr>
            <td>
              {{ Form::text('day[]', $element->day, ['class' => 'form-control', 'placeholder' => _lang('Day'),'required'=>'']) }}
            </td>

            <td>
              {{ Form::text('date[]', $element->date, ['class' => 'form-control date', 'placeholder' => _lang('Date'),'required'=>'']) }}
            </td>

            <td>
              {{ Form::textarea('plan[]', $element->plan, ['class' => 'form-control summernote', 'placeholder' =>  _lang('Plan'), 'style' => 'resize: none;', 'rows' => '3','required'=>'']) }}
            </td>
            <td>
