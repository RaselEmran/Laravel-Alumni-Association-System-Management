...
@endif
     <div class="row">
      <div class="col-md-12">
        ...
        <div class="col-md-12">
        <div class="form-group">
            {{ Form::label('year', _lang('Session Year') , ['class' => 'col-form-label required']) }}

            {{ Form::text('year', null, ['class' => 'form-control', 'placeholder' => _lang('Session Year'),'required'=>'']) }}
          </div>
      </div>
